...
const DeliveryManagement = () => {
      ...
      if (isRestaurateur) {
        try {
          ...
          if (userRestaurant && userRestaurant._id) {
            ...
            // Select the city of this restaurant
  ...
  // Filter deliveries based on status and restaurant filters - same logic for both roles
  const filteredDeliveries = deliveries.filter((delivery) => {
    ...
    const showBasedOnRestaurant =
      !filters.restaurantId ||
      (delivery.restaurant && delivery.restaurant._id === filters.restaurantId);

    // For both roles, apply both status and restaurant filters
    return showBasedOnStatus && showBasedOnRestaurant;
  });
